        ...
        <div class="page-title-box">
            <div class="container-fluid">
                <div class="page-title dflex-between-center">
                    <h3 class="mb-1 font-weight-bold">Edit Song</h3>
        ...
        <div class="page-content-wrapper mt--45">
            <div class="container-fluid">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="songForm" action="{{ route('music.song.update', encrypt($song->id)) }}" method="POST"
                            ...
                            <div class="row">
                                <div class="col-12 col-lg-6">
                                    <div class="form-group floating-label enable-floating-label show-label">
                                        <input id="title" name="title" type="text" placeholder="Enter Song Title"
                                            class="form-control" value="{{ old('title', $song->title) }}">
                                ...
                                <div class="col-12 col-lg-6">
                                    <div class="form-group floating-label enable-floating-label show-label">
                                        <select class="form-control" id="category" name="category">
                                            ...
                                            <option value="{{ $category->id }}" {{ old('category', $song->category)
                                ...
                                <div class="col-12 col-lg-6">
                                    <div class="form-group floating-label enable-floating-label show-label">
                                        <select class="form-control" id="singer" name="singer">
                                            ...
                                            <option value="{{ $singer->id }}" {{ old('singer', $song->singer) ==
                                                $singer->id ? 'selected' : '' }}>
                                                {{ $singer->name }}
                                            </option>
                                            @endforeach
                                ...
                                <div class="col-12 col-lg-6">
                                    <div
                                        class="form-group row m-0 justify-content-between floating-label enable-floating-label show-label">
                                        <input type="file" id="song" name="song" class="form-control"
                                            style="width: 87%;">
                                        <label for="song">Song (MP3)</label>
                                        <div style="width: 10%; overflow: hidden;">
                                            <audio controls width="20px" height="48px"
                                                style="object-fit: cover; border-radius: 8px; width:55px!important;">
                                ...
                                <div class="col-12 col-lg-6">
                                    <div>
                                        <div
                                            ...
                                            <div style="width: 10%; overflow: hidden;"><img
                                                    src="{{ url($song->cover_image) }}" alt="" width="100%"
                                                    height="48px" style="object-fit: cover; border-radius: 8px;">
                                            </div>
                                            <div class="col-12 validation-error font-size-13 text-danger">
                                                @error('cover_image'){{
                                                $message }}@enderror</div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-12 col-lg-6">
                                    <div
                                        ...
                                        <div style="width: 10%; overflow: hidden;"><img src="{{ url($song->image) }}"
                                                alt="" width="100%" height="48px"
                                ...
                                <div class="col-lg-12 mt-4 clearfix" style="text-align: end;">
                                    <button class="btn btn-primary waves-effect waves-light" data-effect="wave"
                                        type="submit">Update Song</button>
                                </div>
                            </div>
                        </form>
                    </div>
